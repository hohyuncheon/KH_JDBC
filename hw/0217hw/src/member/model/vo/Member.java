...
public class Member {
	...
	public Member(String memberId, String password, String memberName, String gender, int age, String email,
			String phone, String address, String hobby, Date enrollDate, Date deleteDate) {
		super();
		this.memberId = memberId;
		this.password = password;
		this.memberName = memberName;
	...
	public String toString() {
		...
		String s = "Member [memberId=" + memberId + ", password=" + password + ", memberName=" + memberName + ", gender="
				+ gender + ", age=" + age + ", email=" + email + ", phone=" + phone + ", address=" + address
				+ ", hobby=" + hobby + ", enrollDate=" + enrollDate + "]";
		if(deleteDate!=null) {
			s+="deleteDate = "+deleteDate;
		}
		return s;
	}
